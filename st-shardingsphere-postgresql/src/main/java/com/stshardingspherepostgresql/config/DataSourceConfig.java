package com.stshardingspherepostgresql.config;
 ...
 */
@Configuration
@MapperScan(basePackages = "com.stshardingspherepostgresql.mapper", sqlSessionFactoryRef = "sqlSessionFactory")
public class DataSourceConfig {
    ...
    public DataSource shardingDataSource() throws SQLException {
        ...
        // 默认的分库策略
        src.setDefaultDatabaseShardingStrategyConfig(new StandardShardingStrategyConfiguration("id", DBShardAlgo.class.getName()));
        // 默认的分表策略
        src.setDefaultTableShardingStrategyConfig(new StandardShardingStrategyConfiguration("id", TblPreShardAlgo.class.getName(),TblRangeShardAlgo.class.getName()));
    ...
    private Map<String, DataSource> createDataSourceMap() {
        ...
        result.put("ds0", createDataSource("jdbc:postgresql://192.168.2.106:5432/ds0"));
        result.put("ds1", createDataSource("jdbc:postgresql://192.168.2.106:5433/ds1"));
        return result;
    }
