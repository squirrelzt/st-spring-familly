...
public class EnumJacksonConfig {
    ...
    public static class Serializer extends JsonSerializer<BaseEnum> {
        @Override
        public void serialize(BaseEnum labelValue, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) throws IOException, JsonProcessingException {
     ...
     */
    public static class LabelValueDeserializer extends JsonDeserializer<BaseEnum> {
        ...
        public BaseEnum deserialize(JsonParser p, DeserializationContext ctxt)
            ...
            for (Object enumConstant : enumClass.getEnumConstants()) {
                if (((BaseEnum) enumConstant).getValue().equals(intValue)) {
